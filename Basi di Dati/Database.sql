...
CREATE TABLE STUDENTE(
	CodiceStudente INTEGER PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY,
	Nome VARCHAR(20),
	Cognome VARCHAR(20),
	DataNascita NascitaLecita,
	LuogoNascita VARCHAR(30),
	CONSTRAINT C1 UNIQUE(Nome,Cognome,LuogoNascita,DataNascita)
	);
...
CREATE TABLE ISCRIZIONE(
	CodiceCorso INTEGER GENERATED BY DEFAULT AS IDENTITY,
	CodiceStudente INTEGER,
	FOREIGN KEY(CodiceCorso) REFERENCES CORSO(CodiceCorso),
	FOREIGN KEY(CodiceStudente) REFERENCES STUDENTE(CodiceStudente),
