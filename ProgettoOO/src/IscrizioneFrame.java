...
public class IscrizioneFrame extends JFrame {
	...
	private JTable CorsiDisponibiliTable;
	...
	public IscrizioneFrame(Controller c) {
		...
		gbl_contentPane.columnWidths = new int[]{123, 129, 31, 0, 0};
		...
		gbc_cognomeTF.gridx = 1;
		gbc_cognomeTF.gridy = 2;
		...
		gbc_dataDiNascitaLabel.gridx = 0;
		gbc_dataDiNascitaLabel.gridy = 3;
		...
		gbc_dataDiNascitaTF.gridx = 1;
		gbc_dataDiNascitaTF.gridy = 3;
		...
		CorsiDisponibiliTable = new JTable();
		CorsiDisponibiliTable.setModel(new DefaultTableModel(
			new Object[][] {
		...
		scrollPane.setViewportView(CorsiDisponibiliTable);
		...
		gbc_luogoDiNascitaLabel.gridx = 0;
		gbc_luogoDiNascitaLabel.gridy = 4;
		...
		gbc_luogoDiNascitaTF.gridx = 1;
		gbc_luogoDiNascitaTF.gridy = 4;
		...
		gbc_codiceDelCorsoLabel.gridx = 0;
		gbc_codiceDelCorsoLabel.gridy = 5;
		...
		gbc_codiceCorsoTF.gridx = 1;
		gbc_codiceCorsoTF.gridy = 5;
